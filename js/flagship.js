    ...
    document.querySelectorAll('.project_read_btn').forEach((arr, index) => {
        arr.addEventListener('click', () => {
            ...
            if(index !== 0){
                ...
                <div class="project_tab">
                    <img src="/investment 2.png" alt="" srcset="">
                ...
                <div class="project_tab">
                    <img src="/59942 1.png" alt="" srcset="">
                    <h2>LOCATION</h2>
                </div>
